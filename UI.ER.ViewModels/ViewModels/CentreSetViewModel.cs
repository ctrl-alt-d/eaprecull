...
namespace UI.ER.ViewModels.ViewModels
{
    ...
    public class CentreSetViewModel
        : SetViewModelBase<CentreRowViewModel, Dtoo.Centre>,
          ISetViewModel<CentreCreateViewModel, Dtoo.Centre>
    {
        public CentreSetViewModel(IServiceFactory serveis, bool modeLookup = false)
            : base(serveis, modeLookup)
        {
            ...
            {
                var update = new CentreCreateViewModel(Serveis);
        ...
        protected override async Task<OperationResults<Dtoo.Centre>> Consulta()
        {
            ...
            // Petició al backend
            using var bl = Serveis.GetBLOperation<ICentreSetAmbActuacions>();
            return await bl.FromPredicate(Parms);
        }

        protected override CentreRowViewModel CreaFila(Dtoo.Centre dto)
